...
EJERCICIO 2: Detectando fallos en el código
...
Una vez hayas intentado averiguar cuales de los códigos están mal, ejecútalos en JavaScript para comprobar si has acertado y comprueba qué tipo de error aparece para entender mejor qué sucede en cada caso.

* * *

EJERCICIO 3: Aprendiendo a averiguar el scope con las Dev Tools
